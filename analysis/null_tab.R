...
paramdf %>%
  ...
  xtable(digits = c(0, 0, 0, rep(2, 4)),
         label = "tab:t1e",
         caption = "Type I error at significance level $\\alpha = 0.01$ for the four tests considered in this thesis for different gamete frequencies and different sample sizes. Since the null is satisfied, all values should be at or below 0.01.") %>%
